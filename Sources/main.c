...
const char * IoCGIhandler(int iIndex, int iNumParams, char *pcParam[], char *pcValue[])
{
uint32_t i = 0;
...
if (iIndex == 0)
	{
		GPIO_DRV_WritePinOutput(RELE1, 0);
		GPIO_DRV_WritePinOutput(RELE2, 0);
		GPIO_DRV_WritePinOutput(RELE3, 0);
		GPIO_DRV_WritePinOutput(RELE4, 0);
...
const tCGI IoCGI={"/io.cgi", IoCGIhandler};
...
#define numSSItags 2
int incremento = 24;
char myStr3[] = "As informacoes ";
char myStr4[] = "apresentadas aqui ";
char myStr5[] = "variam como ";
char myStr6[] = "modo de testar ";
char myStr7[] = "a atualizacao ";
char myStr8[] = "dos campos ";
char myStr9[] = "das tags ";
char myStr[] = {"   "};
...
{
if (incremento < 126) incremento++; else incremento = 25;
if (incremento != 32) {
	sprintf(myStr, "%d", incremento);
}
	else {
		myStr[0] = 32;
		myStr[1] = 32;
...
if (iIndex == 0) //is “tag1”
{
char myStr1[] = "Caractere enviado pela placa:                            "; //string to be displayed on web page
...
switch(incremento){
	...
	case 27:{
		strcpy(myStr1, myStr5);
		break;
	}
	case 29:{
		strcpy(myStr1, myStr7);
		break;
	}
	case 31:{
		strcpy(myStr1, myStr9);
		break;
	}
	default:{
		myStr1[30] = incremento;
		myStr1[31] = 32;
		myStr1[32] = 65;
		myStr1[33] = 83;
		myStr1[34] = 67;
...
{
char myStr2[] = "Outro caractere enviado pela placa:                            "; //string to be displayed on web page

switch(incremento){
	case 26:{
		strcpy(myStr2, myStr4);
		break;
	}
	case 28:{
		strcpy(myStr2, myStr6);
		break;
	}
	case 30:{
		strcpy(myStr2, myStr8);
		break;
	}
	case 32:{
		strcpy(myStr2, myStr);
...
/*lint -restore Enable MISRA rule (6.3) checking. */
{
  ...
  OSA_Init();
  lwip_init();
  IP4_ADDR(&fsl_netif0_ipaddr, 192,168,0,100);
  IP4_ADDR(&fsl_netif0_netmask, 255,255,255,0);
  IP4_ADDR(&fsl_netif0_gw, 192,168,0,1);
...
#endif
/////////////////////////////////////////////////////
//////// Escrever código útil a partir daqui ////////
/////////////////////////////////////////////////////
}
